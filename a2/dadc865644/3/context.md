...
How can we make it more visible that the project name is clickable to go to the project deatil page?

### Prompt 17

can we just remove the edit button on the projects page? and only support edit name and description on the project detail page?

### Prompt 18

Then in the project detail page, we should delete the Edit button, since it's now only can be used to change the name and description. Instead, we can have pencil icon when we hover to the title and description, click other place trigger the save

### Prompt 19

Now the title and description are on the same line which should be two lines?
