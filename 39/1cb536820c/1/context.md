...
subcription should support multiple-selection, if I need to publish all the projects to the same channel, then I need to create a lot of subscriptions
...
There's still a gap that what if I need to track all the sources from all the projects?

### Prompt 7

The subscription type should be either source releases / semantic release, the current project/source is confusing
