...
Support version filter for sources' release, so while fetching releases from a source, certain version patterns can be filer-out
...
Did you do the changes for ux?

### Prompt 6

No, looks good, for the github, it seems we can have a filter for "Exclude Pre-Releases from notifications"
