...
commit on main is fine.
And please make the source style consistent in the source header for subscriptions in the project detailed page
...
Can we make the channel header in subscription similar stype - icon + name
