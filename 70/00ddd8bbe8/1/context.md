...
Can we add path in the url so that we can reload the subpage in the project easily like http://localhost:3001/projects/86a3dc7a-a197-454f-8829-951629afe59c/release_gate or similar
...
Support release gate in cli

### Prompt 44

Remove the delete/reset action entirely
