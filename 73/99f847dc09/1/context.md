...
release this week should count by the release date, not the polled date

### Prompt 12

The "View all" for the recent activity goes to the release page, but it could also contain semantic releases, please redesign this part

### Prompt 13

needs attention current is zero, I think if we put this needs attention here then we need to consider the clean up logic, otherwise the numbers will keep increasing right? WE should remove it and probably we can add a graph to show the trend of releases/semantic releases count monthly/weeky/daily
