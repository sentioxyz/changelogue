...
Add a feature to show the logo of project in the projects page and its detail page, we can follow the priority like github, gitlab, docker etc. If there's no logo can be found, then we can use a placeholder logo
...
gitlab also have the avatar? I doesn't see it why?
