...
Not it goes to `http://localhost:3001/`

### Prompt 40

No, `http://localhost:3001/auth/me` returns `{"id":"00000000-0000-0000-0000-000000000000","github_id":0,"github_login":"dev","name":"Dev User"}`

### Prompt 41

No, you can also have a try

### Prompt 42

looks good, it seems my browser cache
...
The production never needs the auth is it because we don't set the github org right?
