...
Let's show trends today https://github.com/trending not all most stars repositories

### Prompt 13

while adding the trending project,  we should poll the source imediatelly

### Prompt 14

Can you mix the trending projects from all the providers (there's no switcher for providers), and using the led like Marquee/Scroller to display these projects, when hover to it, it stops and then you can click to add it
...
components/dashboard/discovery-section.tsx (185:11) @ DiscoverySection


  183 |
  184 |           {/* Scrolling track — duplicated for seamless loop */}
> 185 |           <div
      |           ^
  186 |             classNam...
